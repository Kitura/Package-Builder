...
# Environment vars
export UBUNTU_VERSION=`lsb_release -a | grep Description | awk '{print tolower($2) $3}' | awk -F. '{print $1"."$2}'`
export UBUNTU_VERSION_NO_DOTS=`lsb_release -a | grep Description | awk '{print tolower($2) $3}' | awk -F. '{print $1$2}'`
