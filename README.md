...
To test your package against multiple versions of swift, simply include a `.swift-versions` file containing the desired secondary versions, separated by a semicolon as shown below:
```
$ cat .swift-versions
